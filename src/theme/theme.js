...
const createVariant = (variant, fontSize, fontWeight, smallFontSize) => {
...
const Theme = createTheme({
    ...
    components: {
        ...
        MuiTypography: {
            ...
            variants: [
                ...
                // Paragraph
                createVariant('p-bold', 16, 700, 12),
                createVariant('p-medium', 16, 400, 12),
                createVariant('p-secondary-bold', 16, 700, null),
                createVariant('p-secondary-medium', 16, 400, null),
    ...
    MuiButton: {
        ...
        variants: [
            ...
            {
                props: { variant: 'outlined', isFocusStyle: true },
                style: ({ ownerState }) => {
                    const colorKey = ownerState.color || 'primary'
                    const colorValue = buttonColors[colorKey] || colors.primary.main
                    ...
                    return {
                        ...
                        ':hover': {
                            backgroundColor: colors.primary.main100,
                            border: `1px solid ${colorValue}`,
                        },
                        ':focus': {
                            border: `1px solid ${colorValue}`,
